 ...
 * @author 182220040
 */
public class ViewEdicaoProd extends javax.swing.JFrame {

    /**
     * Creates new form janelaEdicao
     */
    public ViewEdicaoProd() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewEdicaoProd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewEdicaoProd().setVisible(true);
            }
        });
    }
